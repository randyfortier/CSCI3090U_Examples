...
std::vector<glm::vec3> ObjMesh::getIndexedPositions() {
	return this->indexedPositions;
}

std::vector<glm::vec2> ObjMesh::getIndexedTextureCoords() {
	return this->indexedTextureCoords;
}

std::vector<glm::vec3> ObjMesh::getIndexedNormals() {
